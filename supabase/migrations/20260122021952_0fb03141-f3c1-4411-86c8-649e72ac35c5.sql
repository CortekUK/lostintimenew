-- Fix v_stock_on_hand view to NOT include reserve/release movements
-- Reservations are handled at application level via deposit_order_items query
-- This prevents double-counting of reserved stock
...
SELECT
  ...
  COALESCE(SUM(CASE
    ...
    -- reserve/release excluded - handled by deposit_order_items at app layer
    ELSE 0
